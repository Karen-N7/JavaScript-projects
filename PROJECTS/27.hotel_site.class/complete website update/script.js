...
class UI {
    constructor(state) {
        this.section1Grid = state._section1Grid
        this.cartItems = state._cartItems
        this.cartTotal = state._cartTotal
        this.cartItemWrapper = state._cartItemWrapper
        this.overlay = state._overlay
        this.cartBtn = state._cartBtn
        this.hideBtn = state._hideBtn
        this.opHandler = state._opHandler
        this.clearBtn = state._clearBtn
    }
    ...
    setupAPP() {
        ...
        this.cartBtn.onclick = () => this.showCart()
        this.hideBtn.onclick = () => this.hideCart()
        this.opHandler.onclick = () => this.hideCart()
    }
    populateCart(cart) {
        cart.forEach(item => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var ui = new UI(state)
    products.getProducts('./products.json').then(products => {
        ui.setupAPP()
